...
const WorkingTogether = () => {
  ...
  return (
    <section className="py-20 bg-gradient-to-br from-slate-900 via-gray-900 to-emerald-900">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          <h2 className="text-4xl md:text-5xl font-bold text-white mb-6">
            Partner with FoodAgri AI, and We'll Show You How To:
          </h2>
          ...
          {workingSteps.map((step, index) => (
            ...
            >
              <div className="w-16 h-16 bg-emerald-500/20 rounded-2xl flex items-center justify-center mb-6">
                <SafeIcon icon={step.icon} className="w-8 h-8 text-emerald-400" />
              </div>
            ...
            >
              <div className="flex items-start space-x-4">
                <div className="w-16 h-16 bg-emerald-500/20 rounded-2xl flex items-center justify-center flex-shrink-0">
                  <SafeIcon icon={result.icon} className="w-8 h-8 text-emerald-400" />
                </div>
                <div className="flex-1">
                  ...
                  <div className="bg-emerald-600 text-white px-4 py-2 rounded-full text-sm font-semibold inline-block">
                    {result.metric}
                  </div>
                </div>
              </div>
